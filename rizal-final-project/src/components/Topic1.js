...
import arrive1 from '../assets/hero-arrive1.jpg';
import house from '../assets/hero-house.jpg';
import workshop from '../assets/hero-workshop.jpg';
import clinic from '../assets/hero-clinic.jpg';
import religion from '../assets/hero-religion.jpg';
import religion1 from '../assets/hero-religion1.jpg';
import career from '../assets/hero-career.jpg';
import career1 from '../assets/hero-career1.jpg';
import affair from '../assets/hero-affair.jpg';
import affair1 from '../assets/hero-affair1.jpg';
import katipunan from '../assets/hero-katipunan.jpg';
import katipunan1 from '../assets/hero-katipunan1.jpg';
import cuba from '../assets/hero-cuba.jpg';
import cuba1 from '../assets/hero-cuba1.jpg';
import farewell from '../assets/hero-farewell.jpg';
...
import hero4 from '../assets/carousel-hero4.jpeg';
import hero5 from '../assets/carousel-hero5.jpg';
import hero6 from '../assets/carousel-hero6.jpg';
import hero7 from '../assets/carousel-hero7.jpg';
import hero8 from '../assets/carousel-hero8.jpg';
...
function Article() {
  ...
  return (
    ...
    <h1 className='text-center title'  
        ...
        data-aos-duration="1500"
        data-aos-offset="200"
        >PEACEFUL LIFE OF RIZAL IN DAPITAN </h1>
      <div className="article__content"  
        data-aos="fade-up"
        data-aos-duration="1500"
        data-aos-offset="200"
    ...
    <h1 className='text-center title'  
      ...
      <div className="article__content"  
        ...
        >
        <p>
          In Dapitan, Rizal engaged in a religious scholarly debate with Father Pablo Pastells. This heated debate revealed Rizal's anti-Christianity - his resentment of friars who committed atrocities in the name of the sacred religion. Father Pastells made every effort, fortunately or unfortunately, in vain, to win Rizal back to the faith. These debates ended inconclusively, with neither of them persuaded of the other's judgments/arguments.
        </p>
    ...
    <h1 className='text-center title'  
        ...
        data-aos-duration="1500"
        data-aos-offset="200"
        >KATIPUNAN SEEKS RIZAL ADVICE</h1>
      <div className="article__content"  
        data-aos="fade-up"
        data-aos-duration="1500"
        data-aos-offset="200"
    ...
    <h1 className='text-center title'  
        ...
        data-aos-duration="1500"
        data-aos-offset="200"
        >RIZAL AS A VOLUNTEER IN CUBA</h1>
      <div className="article__content"  
        data-aos="fade-up"
        data-aos-duration="1500"
        data-aos-offset="200"
        >
        <p>
          During the height of the Cuban revolution, Rizal offered his services as a military doctor to compensate for the country's physician shortage. Ferdinand Blumentritt, a friend of his, informed him of the situation in Cuba and suggested that he volunteer as an army doctor. Rizal sent a letter to Governor General Ramon Blanco on December 17, 1895, expressing his willingness to serve Cuba. But after months of waiting for the governor's response, Rizal gave up hope that his request would be granted. Only on July 30, 1896 did Rizal receive a letter from Governor Blanco accepting his offer, dated July 2, 1896. Rizal will also be given a pass to travel to Manila and then to Spain, where the Minister of War will assign him to the Army of Operations in Cuba. 
        </p>
    ...
    <h1 className='text-center title'  
      ...
      <div className="article__content"  
        ...
        >
        <p>
          Jose Rizal boarded the steamer España at midnight on July 31, 1896, with Narcisa, Josephine, Angelica (Narcisa's daughter), three nephews, and six of his students. Many people were saddened when Dapitan's adopted son left. <br/><br/>He raised his hand in farewell to the kind and hospitable people of Dapitan, saying: " Adios, Dapitan!" He gazed at the crowded shore for the last time. His heart was filled with sorrow. When he could no longer see the dim shoreline, he turned sadly into his cabin.
        </p>
    ...
    <h1 className="article__title text-center py-3" data-aos="fade-up">ISSUES OF RIZAL  </h1>
    <h1 className='text-center title'  
        data-aos="fade-left"    
        data-aos-duration="1500"
        data-aos-offset="200"
      ...
      <div className="article__content"  
        ...
        >
        <p>
          Dr. Jose Rizal is widely regarded as the country's national hero by many Filipinos. This is despite the fact that no law or legislation recognizes any Filipino historical figure as a national hero to this day. As a national hero, Rizal is elevated above other Filipino heroes who have also given their lives for the country. Fame and popularity are not the only benefits of such recognition; Jose Rizal is also the Philippines most 'questioned' hero. Along with Dr. Jose Rizal's status as the Philippines' National Hero, there are issues and controversies that call into question and, to some extent, negate his heroism. The debate over this has yet to be resolved and is still ongoing. At the moment, many Filipinos have mixed feelings about Jose Rizal and his heroism.
        </p>
    ...
    <h1 className='text-center title'  
        ...
        data-aos-duration="1500"
        data-aos-offset="200"
        >JOSE RIZAL AND THE SELECTION FOR PHILIPPINE NATIONAL HERO </h1>
      ...
      <div className="article__content"  
       ...
       <p>
        <ol>
          ...
          <li>
          Heroes are those who define and contribute to the nation's system or way of life of freedom and order.
          </li>
          <li>
       ...
       <p>
        <ol>
          ...
          <li>
          A hero considers the future, particularly future generations.
          </li>
          <li>
       ...
       <p>
          <ol type='A'>
            ...
            <li>Apolinario Mabini</li>
            <li>Marcelo H. Del pilar</li>
            <li>Sultan Dipatuan Kudarat</li>
            <li>Juan Luna</li>
      ...
      <h1 className='text-center title'  
        ...
        data-aos-duration="1500"
        data-aos-offset="200"
        >ISSUES AND CONTROVERSIES ON THE HEROISM OF DR. JOSE RIZAL </h1>
      <div className="article__content"  
        data-aos="fade-up"
        data-aos-duration="1500"
        data-aos-offset="200"
        >
       <h3 className='title'>RETRACTION CONTROVERSY </h3>

        <p>
          Four documents were discovered that contained Jose Rizal's retraction a day before his execution. Jose Rizal's rejection of masonry is stated in the retraction, as is his repudiation of his words, writings, publication, and conduct that were against the Catholic Church. Jose Rizal's alleged retraction was a requirement for him and Josephine Bracken to marry. <br/> <br/>
          Scholars who question the existence and authenticity of Jose Rizal's alleged retraction argue that it is a forgery based on handwriting analysis, the existence of multiple versions of the document, the alleged confession of the forger, and discrepancies in the contents of the various versions of the document. They also questioned the document's existence, pointing out that no member of Rizal's family had seen it, that it did not save Rizal from execution, and that there is no public record of Rizal and Bracken's marriage.

        </p>
        <h3 className='title'>AMERICAN SPONSORSHIP </h3>

        <p>
        Renato Constantino argued in his seminal work, Veneration Without Understanding, that Rizal's preeminence among our heroes was partly due to American sponsorship, citing laws enacted by Americans that ‘reduced' the role of other historical figures in our history in order to emphasize the role of Jose Rizal. He contended that the Americans elevated Jose Rizal above other heroes by enacting laws such as Act No. 137, which established the Rizal province, Act No. 243, which authorized the construction of the Rizal Monument in Luneta, and Act No. 346, which established December 30 as Rizal Day. He also claimed that Rizal was chosen because his image of peace and compromise, as well as the perception that he never advocated for independence, suited their (American) imperialistic interests in the Philippines.  <br/> <br/>
        On the other side of the debate, Professor Ambeth Ocampo, a known Rizal 'expert,' refuted Constantino's claims, claiming that Jose Rizal was already venerated long before the Americans sponsored him, citing President Emilio Aguinaldo's December 20, 1898 proclamation designating December 30 as a National Day of Mourning in honor of Jose Rizal. He claimed that "the Americans simply built on the people's prevailing sentiment" toward Rizal. They used Rizal's anti-Spanish, assimilationist, reformist, and peace-loving stance to advance their colonial/imperialistic agenda. 
        </p>
        <h3 className='title'>WAS RIZAL ANTI-REVOLUTION? </h3>

        <p>
        According to historian Renato Constantino, Rizal was an anti-revolutionary who betrayed the Philippines on two occasions: when he volunteered to serve as a doctor for the Spanish armies in the Cuban revolution and when he issued his December 15, 1898 letter in which he not only denied his participation in the revolution but also condemned it as disastrous and a waste of lives. Other historians and scholars point to Rizal's assimilate stance as evidence of his anti-revolutionary beliefs.  <br/> <br/>
        Professor Floro Quibuyen argued in his book A Nation Aborted: Rizal, American Hegemony, and Philippine Nationalism that Rizal was a revolutionary. He cited several pieces of evidence, including Rizal's letters explaining his ideas about the revolution and Dr. Pio Valenzuela's most recent testimony. He also provided a different reading and interpretation of Jose Rizal's Dec 15 manifesto, noting that he did not oppose the revolution but saw it as premature and lacking proper preparations. He contended that in Rizal's final poem, he praised revolutionaries, and that this poem became an inspiration for revolutionaries. He also contended that Jose Rizal could not be anti-revolutionary because many of his family members were members of the Katipunan and held important positions in it.
        </p>
        <h3 className='title'>WAS RIZAL AN AMBIVALENT HERO OR FENCE SITTER?</h3>

          <p>
          Four contradictory testimonies of Pio Valenzuela (2 in 1896 while a prisoner in Fort Santiago) and in 1914 and 1917 contributed to the perception of Jose Rizal as an ambivalent hero. These testimonies all revolve around his meeting with Jose Rizal in Dapitan. The first two testimonies state that Rizal completely rejected the revolution, whereas the other two claim that Rizal did not completely reject the revolution and had given instructions to the Katipunan to ensure the rebellion's success.  <br/> <br/>
          Some historians argue that Rizal was ambivalent, citing works in which he rejected armed struggle as a means of social transformation and others in which he expresses his support for the revolution. Some historians, on the other hand, argued that in order to determine whether or not Rizal was ambivalent, Jose Rizal must be read in the proper context and perspective. They also contended that Jose Rizal was a product of his time and society, and thus Rizal must be read in the context of 19th-century Philippines and from the perspective of Filipinos at the time.
          </p>
          <h3 className='title'>IS RIZAL STILL RELEVANT?</h3>
            ...
            <p>
              <ul>
                ...
                <li>
                Jose Rizal's characteristics are admirable. He serves as a role model and inspiration for Filipino youth to love and serve their country and fellow citizens.
                </li>
                <li>
                Studying Jose Rizal and the history of the country makes us aware of the ideals upon which our country was founded. Studying our forefathers' sacrifices for our country's freedom and sovereignty fosters nationalism and pride in our national identity.
                </li>
                <li>
